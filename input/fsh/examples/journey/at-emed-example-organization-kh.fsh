Instance: At-Emed-Example-Organization-Kh-01
InstanceOf: HL7ATCoreOrganization
Title: "Beispiel Organisation Krankenhaus 01"
...
* address.use = #work
* address.type = #both
* address.line = "Krankenhaus-Straße 1-7 Haupteingang"
* address.line.extension[0].url = "http://hl7.org/fhir/StructureDefinition/iso21090-ADXP-streetName"
* address.line.extension[=].valueString = "Krankenhaus-Straße"

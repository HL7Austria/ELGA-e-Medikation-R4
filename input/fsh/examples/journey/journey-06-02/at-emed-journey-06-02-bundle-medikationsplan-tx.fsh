...
* entry[Medikationsplan].fullUrl = "https://example.elga.com/List/At-Emed-Journey-06-02-List-Medikationsplan"
* entry[Medikationsplan][=].request.method = #PUT 
* entry[Medikationsplan][=].request.url = "List/At-Emed-Journey-06-02-List-Medikationsplan"

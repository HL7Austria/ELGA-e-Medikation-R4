...
* entry[Medikationsplan].fullUrl = "https://example.elga.com/List/4cb4dceb-173f-461a-a267-683ec33e4be1" // -> vom server vergebene id verwenden, bei jedem put der liste verwenden
...
* entry[Medikationsplaneintrag][=].fullUrl = "https://example.elga.com/MedicationRequest/urn:uuid:5e947f71-6881-46cc-9b06-81a1743aa674"  // vorübergehende id vom client erzeugt bei post
* entry[Medikationsplaneintrag][=].request.method = #POST 
* entry[Medikationsplaneintrag][=].request.url = "MedicationRequest/urn:uuid:5e947f71-6881-46cc-9b06-81a1743aa674"

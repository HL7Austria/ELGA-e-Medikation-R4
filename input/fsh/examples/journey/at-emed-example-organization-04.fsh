Instance: At-Emed-Example-Organization-04
InstanceOf: HL7ATCoreOrganization
Title: "Beispiel Organisation Urlaubsvertretung"
...
* address.use = #work
* address.type = #both
* address.line = "Urlaubsvertreter-Straße 8 Stiege 2"
* address.line.extension[0].url = "http://hl7.org/fhir/StructureDefinition/iso21090-ADXP-streetName"
* address.line.extension[=].valueString = "Urlaubsvertreter-Straße"

Instance: At-Emed-Journey-05-Bundle-Medikationsplan-Tx 
...
// Liste 
* entry[Medikationsplan].resource = At-Emed-Journey-05-List-Medikationsplan-Aenderung
* entry[Medikationsplan].fullUrl = "urn:uuid:62e2daa5-c34b-4b97-8044-fd893bc99a56"
* entry[Medikationsplan][=].request.method = #PUT 
* entry[Medikationsplan][=].request.url = "List/At-Emed-Journey-05-List-Medikationsplan-Aenderung"
// Medikationsplaneinträge
* entry[Medikationsplaneintrag][+].resource = At-Emed-Journey-05-Mr-Planeintrag-01
...
* entry[Medikationsplaneintrag][=].request.url = "MedicationRequest/At-Emed-Journey-05-Mr-Planeintrag-01"
* entry[Medikationsplaneintrag][+].resource = At-Emed-Journey-05-Mr-Planeintrag-02
* entry[Medikationsplaneintrag][=].fullUrl = "urn:uuid:62e2daa5-c34b-4b97-8044-fd893bc99a58"
* entry[Medikationsplaneintrag][=].request.method = #PUT 
* entry[Medikationsplaneintrag][=].request.url = "MedicationRequest/At-Emed-Journey-05-Mr-Planeintrag-02"
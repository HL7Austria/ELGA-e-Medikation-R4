Instance: At-Emed-Journey-04-List-Medikationsplan-Reihenfolge
InstanceOf: AtEmedListMedikationsplan   
Title: "Beispiel Journey 04: Reihenfolge der Planeinträge ändern"
Description: "Beispiel Änderung der Reihenfolge der Medikationsplaneinträge (MedicationReqeusts) durch einen anderen GDA."
Usage: #example

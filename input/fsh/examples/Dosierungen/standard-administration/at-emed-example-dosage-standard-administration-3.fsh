Instance: AtEmedExampleDosageStandardAdministration3
InstanceOf: AtElgaEmedMedicationRequestPlaneintrag
Title: "Beispiel Medikationsplaneintrag mit Dosierung im Tageszeitenschema 3"
...
* dosageInstruction[standardDosage][0].timing.repeat.periodUnit = #wk
...
* dosageInstruction[standardDosage][0].timing.repeat.dayOfWeek[0] = #mon
...
* dosageInstruction[standardDosage][1].timing.repeat.periodUnit = #wk
* dosageInstruction[standardDosage][1].timing.repeat.when[0] = $cs-timing#NIGHT "Nachts"
* dosageInstruction[standardDosage][1].timing.repeat.dayOfWeek = #wed

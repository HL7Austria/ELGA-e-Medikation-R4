...
<ol start="6">
<li>GDA 2 führt ein <a href="interactions.html#custom-operations">POST $readtowrite</a> auf den Medikationsplan aus, während GDA 1 das von der Fachanwendung übermittelte Collection Bundle bearbeitet.<br></li>
<li>bis 9. GDA 2 erhält dasselbe Collection Bundle (mit demselben temporären List.identifier), das zuvor bereits GDA 1 übermittelt wurde.</li>
<li>GDA 2 bearbeitet zeitgleich mit GDA 1 den Medikationsplan.</li>
<li>GDA 2 sendet zuerst mittels <a href="interactions.html#custom-operations-1">POST $write</a> ein Transaction Bundle mit dem aktualisierten Medikationsplan. </li>
<li>Die Fachanwendung prüft, ob der temporär in der Fachanwendung vorgehaltene List.identifier mit dem im Transaction Bundle verwendeten List.identifier übereinstimmt. </li>
<li>Die Prüfung verläuft erfolgreich, der neue Medikationsplan wird gespeichert.</li>
<li>Die Fachanwendung löscht den temporären List.identifier.</li>
<li>GDA 2 erhält eine Meldung, dass der Medikationsplan erfolgreich aktualisiert wurde.</li>
<li>GDA 1 sendet mittels <a href="interactions.html#custom-operations-1">POST $write</a> ein Transaction Bundle mit dem aktualisierten Medikationsplan. </li>
<li>Die Prüfung auf Übereinstimmung des von GDA 1 verwendeten List.identifier und dem von der der Fachanwendung vorgehaltenen temporären identifer schlägt fehl.</li>
<li>Die Fachanwendung lehnt das Speichern ab.</li>
<li>GDA 1 erhält eine Fehlermeldung und muss ein erneutes Read-to-Write ausführen, welches das Generieren eines zur Auslieferung bereitgestellten temporären Collection Bundles inkl. neuem List.identifiers auslöst.</li>
</ol>
